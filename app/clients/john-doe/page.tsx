...
import ClientPageProtection from '../[clientId]/page';
...
// Ressources d'onboarding (mêmes que le template)
...
// Composants modaux (mêmes que le template)
...
export default function ClientPage() {
  ...
  // Sauvegarder les informations du client dans le localStorage
  useEffect(() => {
    localStorage.setItem('clientInfo', JSON.stringify(clientInfo));
  }, []);

  return (
    <ClientPageProtection params={{ clientId: clientInfo.id }}>
